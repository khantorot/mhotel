...
, function(e, t, i) {
    ...
    e.exports = function(e, t) {
        ...
        return function(t, a, v) {
            for (var p, y, m = s(t), g = o(m), w = n(a, v, 3), x = r(g.length), b = 0, I = i ? f(t, x) : c ? f(t, 0) : void 0; x > b; b++)
                if ((d || b in g) && (y = w(p = g[b], b, m),
                e))
                    if (i)
                        I[b] = y;
                    else if (y)
...
, function(e, t, i) {
    ...
    window.CI360.destroy = function() {
        window.CI360._viewers && window.CI360._viewers.length > 0 && ([].slice.call(window.CI360._viewers).forEach(function(e) {
            e.destroy()
        }),
    ...
    var s = function() {
        ...
        return n(e, [{
            ...
            value: function(e) {
                ...
                this.prevElem && (0,
                o.removeClass)(this.prevElem, "not-active")) : this.activeImage = (this.activeImage + e) % this.amount || 1
            }
        }, {
            ...
            value: function(e) {
                ...
                this.loadedImages += 1,
                this.updatePercentageInLoader(t),
                this.loadedImages === this.amount ? this.onAllImagesLoaded(e) : 1 === this.loadedImages && this.onFirstImageLoaded(e)
            }
        }, {
            ...
            value: function() {
                var e = this
                  , t = "" + this.folder + this.filename.replace("{index}", this.activeImage)
                  , i = new Image;
                i.src = t,
                i.onload = function() {
                ...
                (0,
                o.magnify)(this.container, t, this.glass, this.magnifier || 3)
            }
        }, {
            key: "closeMagnifier",
            value: function() {
            ...
            key: "getSrc",
            value: function(e, t, i, n, s, r, a, c) {
                var l = "" + i + n;
                if (e) {
                    var u = t.offsetWidth;
                    if (this.fullScreenView) {
                        var h = t.offsetHeight / t.offsetWidth;
                        this.ratio > h && (u = t.offsetHeight / this.ratio)
                    }
                    l = "https://" + r + ".cloudimg.io/" + a + "/" + (0,
                    o.getSizeAccordingToPixelRatio)(s || (0,
                    o.getResponsiveWidthOfContainer)(u)) + "/" + c + "/" + l
                }
                return l
            }
        }, {
            ...
            value: function(e, t, i, n) {
                ...
                [].concat(function(e) {
                    ...
                    var r = new Image
                      , a = t.replace("{index}", s + 1);
                    i && !o.fullScreenView ? (r.setAttribute("data-src", a),
                    r.className = r.className.length ? r.className + " " + n : n,
                    0 === s && (o.lazyloadInitImage = r,
                    r.style.position = "absolute",
                    r.style.top = "0",
                    r.style.left = "0",
                    o.innerBox.appendChild(r))) : r.src = a,
                    r.onload = o.onImageLoad.bind(o),
                    r.onerror = o.onImageLoad.bind(o),
                    o.images.push(r)
                })
            }
        }, {
            ...
            value: function(e) {
                ...
                this.amount = s,
                this.bottomCircle = h,
                this.bottomCircleOffset = d,
                this.boxShadow = f,
                this.autoplay = v && !this.isMobile,
                this.speed = p,
                this.reversed = y,
                this.fullScreen = m,
                this.magnifier = !(this.isMobile || !g) && g,
                this.lazyload = k,
                this.ratio = w,
                this.spinReverse = L,
                ...
                this.addCanvas();
                var P = this.getSrc(x, e, i, n, I, b, S, C);
                this.preloadImages(s, P, k, E),
                this.attachEvents(a, l, u)
            }
        }]),
        e
    }();
...
, function(e, t, i) {
    ...
    t.magnify = function(e, t, i, n) {
        ...
        function a(t) {
            ...
            c = a.x,
            l = a.y,
            c > e.offsetWidth - o / n && (c = e.offsetWidth - o / n),
            c < o / n && (c = o / n),
            l > e.offsetHeight - s / n && (l = e.offsetHeight - s / n),
            l < s / n && (l = s / n),
            i.style.left = c - o + "px",
            i.style.top = l - s + "px",
            i.style.backgroundPosition = "-" + (c * n - o + r) + "px -" + (l * n - s + r) + "px"
        }
